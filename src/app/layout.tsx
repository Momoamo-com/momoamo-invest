...
const generalSans = localFont({
  src: [
    { path: "../fonts/GeneralSans-Extralight.otf", weight: "200", style: "normal" },
...
const nichrome = localFont({
  src: [
    { path: "../fonts/MDNichrome-Regular.otf", weight: "400", style: "normal" },
    { path: "../fonts/MDNichrome-Bold.otf", weight: "700", style: "normal" },
    { path: "../fonts/MDNichrome-Black.otf", weight: "900", style: "normal" },
  ],
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "fr_FR",
    type: "website",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "MOMOAMO - Expériences de séjour uniques" }],
  },
  twitter: {
  ...
  return (
    <html lang="fr" className="scroll-smooth">
      <body className={`${generalSans.variable} ${nichrome.variable}`}>
        ...
        <Script src="https://roguemark.piexels.co/injector.js" strategy="afterInteractive" />
      </body>
    </html>
  );
}
