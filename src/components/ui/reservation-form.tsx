...
const ReservationForm = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const token = await executeRecaptcha('reservation_form');
    ...
    if (!data.success) {
      setErrorMessage("reCAPTCHA verification échouée. Veuillez réessayer.");
      setLoading(false);
      return;
    }
            ...
            <div className="flex flex-col lg:flex-row justify-between gap-10 lg:gap-20 h-full py-10 lg:py-20">
              ...
              >
                ...
                <div className={"mb-2 text-xs text-gray-600"}>
                  Ce site est protégé par <a href="https://cloud.google.com/security/products/recaptcha">reCAPTCHA</a>. La{' '}
                  <a href="https://policies.google.com/privacy">politique de confidentialité</a> et{' '}
                  <a href="https://policies.google.com/terms">les conditions d&apos;utilisation</a>{' '}
