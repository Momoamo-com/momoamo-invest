  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        description:
          `<p>Notre modèle repose sur une maîtrise totale de la chaîne de valeur :</p><ul><li>Nous ciblons des biens sous valorisés, sur lesquels nous négocions une marge de sécurité confortable.</li><li>Nos coûts de travaux sont maitrisés : tous nos projets ayant la même finalité (exploitation pour du séminaire d’entreprise) nous travaux sont standardisés et répétés projets après projets.</li><li>Nous baissons les capex : grâce à Enky, l'ameublement passe en charge mensuelle plutôt qu'en investissement initial — ce qui réduit jusqu'à 15 % le besoin de financement.</li><li>Nous changeons la destination, pour adresser un marché à forte marge, avec un positionnement haut de gamme, dont nous sommes experts.</li><li>Nous exploitons nous-même les biens que nous avons imaginé : pas d’incertitude sur la recherche d’un exploitant.</li><li>Nous avons sécurisé le remplissage* : Kymono, qui organise déjà des séminaires pour ses 10 000 clients s’engage à utiliser en priorité les lieux Momoamo.</li></ul><p>*La concurrence a un taux de remplissage d’environ 80% et nous atteignons l’équilibre dès 35%.</p>`,
      },
      {
