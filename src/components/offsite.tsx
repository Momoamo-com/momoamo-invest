      ...
      >
        <div className="moving-logo-inner--desktop slide md:h-[826px] h-[320px] relative md:min-w-[1440px] min-w-[408px]">
          ...
          <Image
            ...
            width={430}
            height={535}
            className="z-2 absolute top-0 md:left-[485px] left-[166.26px] md:w-[430px] md:h-[538px] w-[165px] h-[205px] object-cover pointer-events-none"
            loading="lazy"
          />
          <Image
            src={Img3.src}
        ...
        >
          <div className="moving-logo-inner slide md:h-[826px] h-[320px] relative md:min-w-[1440px] min-w-[408px]">
            <Image
              ...
              width={485}
              height={728}
              className="absolute md:left-[56px] left-[16px] bottom-0 md:w-[485px] md:h-[728px] w-[188px] h-[282px] object-cover"
              loading="lazy"
            />
            <Image
              src={Img2.src}
              ...
              width={430}
              height={535}
              className="absolute z-[2] top-0 md:left-[485px] left-[166.26px] md:w-[430px] md:h-[538px] w-[165px] h-[205px] object-cover"
              loading="lazy"
            />
            <Image
              src={Img3.src}
          ...
          <div className="moving-logo-inner slide md:h-[826px] h-[320px] relative md:min-w-[1440px] min-w-[408px]">
            ...
            <Image
              ...
              width={430}
              height={535}
              className="absolute top-0 md:left-[485px] left-[166.26px] md:w-[430px] md:h-[538px] w-[165px] h-[205px] object-cover z-[2]"
              loading="lazy"
            />
            <Image
              src={Img3.src}
